<script lang="ts">
import { ref } from 'vue';
import { icp_chat_backend, canisterId, createActor } from '../../declarations/icp_chat_backend';
import { AuthClient } from '@dfinity/auth-client';
import { HttpAgent } from '@dfinity/agent';
import type { Identity } from '@dfinity/agent';
import { Principal } from '@dfinity/principal';
import type { UserData } from '../../declarations/icp_chat_backend/icp_chat_backend.did';
...
export default {
  ...
  methods: {
    ...
    async pobierzChaty() {
      ...
      this.chats = await icp_chat_backend.get_chat(chatPath)
    },
    async login() {
    ...
    async getUserData() {
      ...
      const maybeUserData = await icp_chat_backend.get_user(principal as Principal)
    ...
    async getAllUsers(){
      this.allUsers = await icp_chat_backend.get_users()
    }
  },
}
</script>
